...
public class Comets : MonoBehaviour, IDamageable
{
    ...
    public void TakeDamage(float damageAmount)
    {
        ...
        {
            canMove = false;
            PlayerMovement.Instance.OnCometDestroyedAfterHit?.Invoke(this, cometType,coinValue);
            Destroy();
        }
    }
    public void Destroy()
    {
        PlayerMovement.Instance.OnCometDestroyed?.Invoke(this, cometType, coinValue);
    }
