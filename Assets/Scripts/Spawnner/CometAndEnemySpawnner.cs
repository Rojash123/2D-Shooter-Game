...
public class CometAndEnemySpawnner : MonoBehaviour
{
    ...
    private void Start()
    {
        PlayerMovement.Instance.OnCometDestroyed += SendBacktoPoolComet;
        PlayerMovement.Instance.OnEnemyDestroyed += SendBacktoEnemy;
        PlayerMovement.Instance.OnObstaclesDestroyed += SendBacktoPoolObstacles;
    }
